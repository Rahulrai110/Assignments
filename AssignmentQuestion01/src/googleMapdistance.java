...
public static Properties prop;
	...
	public Properties loadprop()
	{
		...
		try {
			...
			FileInputStream fis=new FileInputStream("E:\\JarFile_And_ChromeDriver\\browserdriver.properties");
			prop.load(fis);
		} catch (IOException e) {
	...
	public static void main(String[] args) throws IOException {
		...
		googleMapdistance gMapObj = new googleMapdistance();
		prop = gMapObj.loadprop();
